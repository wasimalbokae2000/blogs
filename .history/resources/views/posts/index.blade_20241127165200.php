                    ...
                    <div id="post_{{$post->id}}" class="carousel slide carousel-fade">
                        <div class="carousel-inner">
                          <div class="carousel-item active">
                            <img src="/images/451837112_8010131339064623_8209985163965837871_n.jpg-674708bc2357b.jpg" class="d-block w-100" alt="...">
                          </div>
                          <div class="carousel-item">
                            <img src="/images/windows_black.jpg-674708bc23875.jpg" class="d-block w-100" alt="...">
                        </div>
