...
<div class="card container-fluid">
        <div class="row">
            ...
            <div class="col-12 mt-3 mb-3 ">
                <div class="   d-flex align-items-center justify-content-center">
                        <a class="col-6 w-25 btn px-2 py-2 btn-primary  d-block"  href="{{route('posts.edit',$post->id)}}">Edit</a>
                        <a class="col-6 w-25  btn px-2 py-2 btn-dark d-block"  href="{{route('posts')}}">Back</a>
                </div>
            </div>
        </div>
