...
<head>
    ...
    justify-content: space-between; /* يوزع المحتوى بشكل متساوٍ */
    }
    </style>
    ...
    <div class="card">
        ...
        <div class="card-body">
          ...
          <p class="card-text" style="min-height:60px">
            {{ $post->description }} asdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasd
          </p>
