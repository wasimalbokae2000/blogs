...
<div class="container card w-100" style="background-color: red;width:100%;">
          <div class="row ">
            <div class="col-12">
              <div class="card-body d-flex align-items-center justify-content-center">
                <div class="post">
                    ...
                    <a class="btn px-2 py-2 btn-primary d-flex align-items-center justify-content-center"  href="{{route('posts.edit',$post->id)}}">Edit</a>
                </div>
              </div>
            </div>
            <div class="col-12 ">
