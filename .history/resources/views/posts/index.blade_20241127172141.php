            ...
            <div class="mt-3 mb-3 col-xxl-2 col-xl-4 col-lg-6 col-md-12 col-sm-12">
                <div class="card">
                    <div id="post_{{$post->id}}" class="carousel slide carousel-fade">
                        ...
                        @if (count($imgs)>1)
                        <button class="carousel-control-prev" id="post_{{$post->id}}{{$img}}" target="#post_{{$post->id}}" data-bs-slide="prev">
                          <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                          <span class="visually-hidden">Previous</span>
                        </button>
                        <button class="carousel-control-next"  id="post_{{$post->id}}{{$img}}"  type="button" data-bs-target="#post_{{$post->id}}" data-bs-slide="next">
